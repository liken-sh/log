// The site is a Go module so that Hugo can enter as a tool
// directive. `go tool hugo` builds the pinned version from source
// and runs it, so the site needs no Hugo install and no fetched
// binary, only the Go toolchain. Hugo pins hundreds of modules, and
// they all live in this go.sum, the same way the manuals' docs
// modules keep them out of their operators.

module github.com/liken-sh/log
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudfront v1.69.0 // indirect
	...
	github.com/bep/simplecobra v0.8.0 // indirect
